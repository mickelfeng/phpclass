...
class QQ
{
    ...
    public function login()
    {
        ...
        $keysArr = array('response_type' => 'code',
    ...
    public function callback()
    {
        ...
        $keysArr = array('grant_type' => 'authorization_code',
            'client_id' => $this -> appid,
            'redirect_uri' => $this -> callbcak,
    ...
    {
        $this -> keysArr = array('oauth_consumer_key' => (int)$this -> appid,
        ...
        $this -> APIMap = array(
             ...
             * qzone
             */
            'add_blog' => array('https://graph.qq.com/blog/add_one_blog',
                array('title', 'format' => 'json', 'content' => null),
                'POST'
                ),
            'add_topic' => array('https://graph.qq.com/shuoshuo/add_topic',
                array('richtype', 'richval', 'con', '#lbs_nm', '#lbs_x', '#lbs_y', 'format' => 'json', '#third_source'),
                'POST'
                ),
            'get_user_info' => array('https://graph.qq.com/user/get_user_info',
                array('format' => 'json'),
                'GET'
                ),
            'add_one_blog' => array('https://graph.qq.com/blog/add_one_blog',
                array('title', 'content', 'format' => 'json'),
                'GET'
                ),
            'add_album' => array('https://graph.qq.com/photo/add_album',
            ...
            'list_album' => array('https://graph.qq.com/photo/list_album',
                array('format' => 'json')
                ),
            ...
            'check_page_fans' => array('https://graph.qq.com/user/check_page_fans',
            ...
            'add_t' => array('https://graph.qq.com/t/add_t',
            ...
            'del_t' => array('https://graph.qq.com/t/del_t',
                array('id', 'format' => 'json'),
                'POST'
                ),
            'get_repost_list' => array('https://graph.qq.com/t/get_repost_list',
                array('flag', 'rootid', 'pageflag', 'pagetime', 'reqnum', 'twitterid', 'format' => 'json')
                ),
            'get_info' => array('https://graph.qq.com/user/get_info',
                array('format' => 'json')
                ),
            'get_other_info' => array('https://graph.qq.com/user/get_other_info',
                array('format' => 'json', '#name', 'fopenid')
                ),
            'get_fanslist' => array('https://graph.qq.com/relation/get_fanslist',
                array('format' => 'json', 'reqnum', 'startindex', '#mode', '#install', '#sex')
                ),
            'get_idollist' => array('https://graph.qq.com/relation/get_idollist',
                array('format' => 'json', 'reqnum', 'startindex', '#mode', '#install')
                ),
            'add_idol' => array('https://graph.qq.com/relation/add_idol',
                array('format' => 'json', '#name-1', '#fopenids-1'),
                'POST'
                ),
            'del_idol' => array('https://graph.qq.com/relation/del_idol',
            ...
            'get_tenpay_addr' => array('https://graph.qq.com/cft_info/get_tenpay_addr',
